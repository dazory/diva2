...
class Gps final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_gpgga();
  void set_allocated_gpgga(std::string* gpgga);
  private:
  const std::string& _internal_gpgga() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_gpgga(const std::string& value);
...
class Can final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release___pad();
  void set_allocated___pad(std::string* __pad);
  private:
  const std::string& _internal___pad() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set___pad(const std::string& value);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release___res0();
  void set_allocated___res0(std::string* __res0);
  private:
  const std::string& _internal___res0() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set___res0(const std::string& value);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release___res1();
  void set_allocated___res1(std::string* __res1);
  private:
  const std::string& _internal___res1() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set___res1(const std::string& value);
...
void Gps::set_gpgga(ArgT0&& arg0, ArgT... args) {
 
 gpgga_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sensors.Gps.gpgga)
}
inline std::string* Gps::mutable_gpgga() {
  std::string* _s = _internal_mutable_gpgga();
...
inline void Gps::_internal_set_gpgga(const std::string& value) {
  ...
  gpgga_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Gps::_internal_mutable_gpgga() {
  
  return gpgga_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Gps::release_gpgga() {
  // @@protoc_insertion_point(field_release:sensors.Gps.gpgga)
  return gpgga_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Cam::set_image_data(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Can::set___pad(ArgT0&& arg0, ArgT... args) {
 
 __pad_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sensors.Can.__pad)
}
inline std::string* Can::mutable___pad() {
  std::string* _s = _internal_mutable___pad();
...
inline void Can::_internal_set___pad(const std::string& value) {
  ...
  __pad_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Can::_internal_mutable___pad() {
  
  return __pad_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Can::release___pad() {
  // @@protoc_insertion_point(field_release:sensors.Can.__pad)
  return __pad_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Can::set___res0(ArgT0&& arg0, ArgT... args) {
 
 __res0_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sensors.Can.__res0)
}
inline std::string* Can::mutable___res0() {
  std::string* _s = _internal_mutable___res0();
...
inline void Can::_internal_set___res0(const std::string& value) {
  ...
  __res0_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Can::_internal_mutable___res0() {
  
  return __res0_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Can::release___res0() {
  // @@protoc_insertion_point(field_release:sensors.Can.__res0)
  return __res0_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Can::set___res1(ArgT0&& arg0, ArgT... args) {
 
 __res1_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:sensors.Can.__res1)
}
inline std::string* Can::mutable___res1() {
  std::string* _s = _internal_mutable___res1();
...
inline void Can::_internal_set___res1(const std::string& value) {
  ...
  __res1_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* Can::_internal_mutable___res1() {
  
  return __res1_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* Can::release___res1() {
  // @@protoc_insertion_point(field_release:sensors.Can.__res1)
  return __res1_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Can::set_data(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Log::set___pad(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Log::set___res0(ArgT0&& arg0, ArgT... args) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Log::set___res1(ArgT0&& arg0, ArgT... args) {
