...
int main(int argc, char *argv[])
{
    ...
    // std::thread sensingthread_cam(camSensingThread.run, &socket, ref(m), timestamp); // , "/dev/ttyACM0", "9600"
...
//     string command = "mkdir -p /home/diva2/DIVA2data/"+timestamp+"_0/CAM/JPG"+ " /home/diva2/DIVA2data/"+timestamp+"_0/LiDAR/PCD" + " /home/diva2/DIVA2data/"+timestamp+"_0/GPS" + " /home/diva2/DIVA2data/"+timestamp+"_0/IMU" + " /home/diva2/DIVA2data/"+timestamp+"_0/CAN" + " /home/diva2/DIVA2data/"+timestamp+"_0/JSON";
//     const char *c = command.c_str();
//     system(c);
//     cout<<"makedirectory"<<endl;
...
//     USE_GPS = 1;
//     GpsSensingThread mGpsSensingThread;
//     std::thread sensingthread_gps(mGpsSensingThread.run, ref(m)); // , "/dev/ttyACM0", "9600"

//     USE_CAM = 1;
//     // CamSensingThread camSensingThread;
//     // std::thread sensingthread_cam(camSensingThread.run, &context, ref(m), timestamp); // , "/dev/ttyACM0", "9600"

//     USE_IMU = 1;
//     ImuSensingThread imuSensingThread;
//     std::thread sensingthread_imu(imuSensingThread.run, "/dev/ttyACM0", 115200, ref(m));

//     USE_CAN = 1;
//     // CanSensingThread canSensingThread;
//     // std::thread sensingthread_can(canSensingThread.run, &context, ref(m)); // , "/dev/ttyACM0", "9600"

//     USE_LiDAR = 1;
//     // LiDAR_SensingThread mLiDARSensingThread;
//     // thread sensingthread_LiDAR(mLiDARSensingThread.run, &context, ref(m), 0.1f);
