                ...
                // switch (count){
                // case 9:
                //     {mImuPacket.scaledAccelX = dataPoint.as_float(); break;}
                // case 8:
                //     {mImuPacket.scaledAccelY = dataPoint.as_float(); break;}
                // case 7:
                //     {mImuPacket.scaledAccelZ = dataPoint.as_float(); break;}
                // case 6:
                //     {mImuPacket.scaledGyroX = dataPoint.as_float(); break;}
                // case 5:
                //     {mImuPacket.scaledGyroY = dataPoint.as_float(); break;}
                // case 4:
                //     {mImuPacket.scaledGyroZ = dataPoint.as_float(); break;}
                // case 3:
                //     {mImuPacket.scaledMagX = dataPoint.as_float(); break;}
                // case 2:
                //     mImuPacket.scaledMagY = dataPoint.as_float(); break;
                // case 1:
